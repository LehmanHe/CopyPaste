...
class Clipboard {
  ...
  func copy(_ item: HistoryItem?, removeFormatting: Bool = false) {
    ...
    pasteboard.setString("", forType: .fromCopyPaste)
  ...
  func paste() {
    ...
    // See https://github.com/p0deje/CopyPaste/issues/482 for details.
  ...
  func checkForChangesInPasteboard() { // swiftlint:disable:this cyclomatic_complexity
    ...
    if pasteboard.pasteboardItems?.contains(where: { $0.types.contains(.fromCopyPaste) }) != true {
    ...
    // See https://github.com/p0deje/CopyPaste/issues/241.
    ...
    // - https://github.com/p0deje/CopyPaste/issues/78
    // - https://github.com/p0deje/CopyPaste/issues/472
    ...
    pasteboard.pasteboardItems?.forEach({ item in
      ...
      // https://github.com/p0deje/CopyPaste/issues/613
      // https://github.com/p0deje/CopyPaste/issues/770
  ...
  // - Chrome Remote Desktop (https://github.com/p0deje/CopyPaste/issues/948)
  // - Netbeans (https://github.com/p0deje/CopyPaste/issues/879)
  private func sync() {
  ...
  private func clearFormatting(_ contents: [HistoryItemContent]) -> [HistoryItemContent] {
    ...
    if !stringContents.isEmpty {
      ...
      // Preserve file URLs.
      // https://github.com/p0deje/CopyPaste/issues/962
