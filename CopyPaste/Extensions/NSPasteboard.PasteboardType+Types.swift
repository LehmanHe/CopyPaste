...
extension NSPasteboard.PasteboardType: Defaults.Serializable {
  ...
  // https://github.com/p0deje/CopyPaste/issues/429#issuecomment-1182575226
  static let modified = NSPasteboard.PasteboardType(rawValue: "x.nspasteboard.ModifiedType")

  // Marks that copy was made from CopyPaste.
  static let fromCopyPaste = NSPasteboard.PasteboardType(rawValue: "org.p0deje.CopyPaste")
